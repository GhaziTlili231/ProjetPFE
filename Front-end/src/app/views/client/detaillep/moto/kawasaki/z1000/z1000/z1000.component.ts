...
export class Z1000Component implements OnInit {
  errorMessage: string | null = null;
  isAuthenticated: boolean = false; // Variable pour suivre l'état de l'authentification

  products: Product[] = [];
  filteredProducts: Product[] = [];
  routerLinks: string[] = [
    '/z1000/1', // Filtre d'air
    '/z1000/2', // Filtre de huile
    '/z1000/3', // Plaquettes de freins
    '/z1000/4', // Bougie
    '/z1000/5', // Batterie
    '/z1000/6'  // Pneu
  ];
  ...
  addToCart(product: Product): void {
    if (!this.isAuthenticated) {
      console.error('Vous devez être connecté pour ajouter des produits au panier.');
