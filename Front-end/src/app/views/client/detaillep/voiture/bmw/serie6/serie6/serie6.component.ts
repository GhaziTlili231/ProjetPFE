...
export class Serie6Component implements OnInit {
  errorMessage: string | null = null;

  products: Product[] = [];
  filteredProducts: Product[] = [];
  routerLinks: string[] = [
    '/serie6/1', // Filtre d'air
    '/serie6/2', // Filtre de huile
    '/serie6/3', // Plaquettes de freins
    '/serie6/4', // Bougie
    '/serie6/5', // Batterie
    '/serie6/6'  // Pneu
  ];
