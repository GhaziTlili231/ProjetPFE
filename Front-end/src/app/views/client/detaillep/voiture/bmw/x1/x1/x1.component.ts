...
export class X1Component implements OnInit {
  ...
  routerLinks: string[] = [
    '/x1/1', // Filtre d'air
    '/x1/2', // Filtre de huile
    '/x1/3', // Plaquettes de freins
    '/x1/4', // Bougie
    '/x1/5', // Batterie
    '/x1/6'  // Pneu
  ];
