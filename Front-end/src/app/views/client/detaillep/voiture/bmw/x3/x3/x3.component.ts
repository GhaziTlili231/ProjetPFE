...
export class X3Component implements OnInit {
  ...
  routerLinks: string[] = [
    '/x3/1', // Filtre d'air
    '/x3/2', // Filtre de huile
    '/x3/3', // Plaquettes de freins
    '/x3/4', // Bougie
    '/x3/5', // Batterie
    '/x3/6'  // Pneu
  ];
