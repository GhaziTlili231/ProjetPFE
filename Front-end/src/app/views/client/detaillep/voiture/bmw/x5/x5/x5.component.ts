...
export class X5Component implements OnInit {
  ...
  routerLinks: string[] = [
    '/x5/1', // Filtre d'air
    '/x5/2', // Filtre de huile
    '/x5/3', // Plaquettes de freins
    '/x5/4', // Bougie
    '/x5/5', // Batterie
    '/x5/6'  // Pneu
  ];
