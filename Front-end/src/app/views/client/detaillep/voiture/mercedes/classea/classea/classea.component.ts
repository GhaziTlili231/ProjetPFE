...
export class ClasseaComponent implements OnInit {
  errorMessage: string | null = null;

  products: Product[] = [];
  filteredProducts: Product[] = [];
  routerLinks: string[] = [
    '/classea/1', // Filtre d'air
    '/classea/2', // Filtre de huile
    '/classea/3', // Plaquettes de freins
    '/classea/4', // Bougie
    '/classea/5', // Batterie
    '/classea/6'  // Pneu
  ];
