...
export class ClassegComponent implements OnInit {
  ...
  routerLinks: string[] = [
    '/classeg/1', // Filtre d'air
    '/classeg/2', // Filtre de huile
    '/classeg/3', // Plaquettes de freins
    '/classeg/4', // Bougie
    '/classeg/5', // Batterie
    '/classeg/6'  // Pneu
  ];
