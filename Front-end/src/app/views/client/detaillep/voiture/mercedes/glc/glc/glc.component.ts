...
export class GlcComponent implements OnInit {
  ...
  routerLinks: string[] = [
    '/glc/1', // Filtre d'air
    '/glc/2', // Filtre de huile
    '/glc/3', // Plaquettes de freins
    '/glc/4', // Bougie
    '/glc/5', // Batterie
    '/glc/6'  // Pneu
  ];
