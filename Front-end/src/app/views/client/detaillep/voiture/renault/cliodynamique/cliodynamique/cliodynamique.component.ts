...
@Component({
  selector: 'app-cliodynamique',
  templateUrl: './cliodynamique.component.html',
  styleUrls: ['./cliodynamique.component.css']
})
export class CliodynamiqueComponent implements OnInit {
