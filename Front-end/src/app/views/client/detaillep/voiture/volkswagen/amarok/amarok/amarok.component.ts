...
export class AmarokComponent implements OnInit {
  ...
  routerLinks: string[] = [
    '/amarok/1', // Filtre d'air
    '/amarok/2', // Filtre de huile
    '/amarok/3', // Plaquettes de freins
    '/amarok/4', // Bougie
    '/amarok/5', // Batterie
    '/amarok/6'  // Pneu
  ];
