...
export class CliodynamiqueComponent implements OnInit {
  ...
  routerLinks: string[] = [
    '/cliodynamique/1', // Filtre d'air
    '/cliodynamique/2', // Filtre de huile
    '/cliodynamique/3', // Plaquettes de freins
    '/cliodynamique/4', // Bougie
    '/cliodynamique/5', // Batterie
    '/cliodynamique/6'  // Pneu
  ];
